...
py-1 md:py-1.5 text-slate-100 min-w-40">
    ...
    <span class=" text-white capitalize md:uppercase  md:justify-items-end px-2 hover:bg-red-500 rounded-md  transition-all duration-500 ease-in-out ">
        <a href="patientsHome.jsp">Back</a></span>
</header>
    ...
    <div class="w-100 md:w-130 bg-gray-100 rounded-lg shadow-md">
        <form method="post" action="${pageContext.request.contextPath}/registerByPatient">
            <div class="flex flex-col space-y-2 p-3">
                ...
                <label class="capitalize md:uppercase ">First_Name :<input class="mx-3 rounded-md p-1 bg-slate-50 min-w-54" type="text" value="First Name"/></label>
                <label class="capitalize md:uppercase ">Middle_Name :<input class="mx-0.5.5 rounded-md p-1 bg-slate-50 min-w-52" type="text" value="Middle Name"/> </label>
                <label class="capitalize md:uppercase ">Last_Name :<input class="mx-3 rounded-md p-1 bg-slate-50 min-w-54" type="text" value="Last Name"/></label>
                <label class="capitalize md:uppercase ">Medical_History :<input class="mx-1 rounded-md p-1 min-h-16 bg-slate-50 min-w-48" type="text" value="Medical History"/></label>
                ...
                <label class="capitalize md:uppercase ">First_Name :<input class="mx-3 rounded-md p-1 bg-slate-50 min-w-54" type="text" value="First Name"/></label>
                <label class="capitalize md:uppercase ">Last_Name :<input class="mx-3 rounded-md p-1 bg-slate-50 min-w-54" type="text" value="Last Name"/></label>
                <label class="capitalize md:uppercase ">Number :<input class="mx-3 rounded-md p-1 bg-slate-50 min-w-58" type="number" name="number" value="Phone Number"/></label>
                <p style="color: red;">

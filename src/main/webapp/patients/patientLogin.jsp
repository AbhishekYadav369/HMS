...
<main class="flex items-center justify-center min-h-screen  bg-slate-100">
  <div class="w-90 min-h-40 md:w-120 bg-gray-100 rounded-lg shadow-md">
    <form  method="post" action="check-servlet">
      <div class="  text-capatialize md:uppercase text-lg flex flex-col space-y-4 p-4">
        ...
        <input type="hidden" name="patients_login" value="patients_login">
